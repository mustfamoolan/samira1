    ...
    <div>
        <ul class="flex space-x-2 rtl:space-x-reverse">
            ...
            <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
                <a href="{{ route('admin.employees.index') }}" class="text-primary hover:underline">الموظفين</a>
            </li>
            <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
        ...
        <div class="pt-5">
            <div class="panel">
                <div class="mb-5">
                    <h5 class="font-semibold text-lg dark:text-white-light">تعديل الموظف: {{ $employee->name }}</h5>
                </div>
                ...
                <form method="POST" action="{{ route('admin.employees.update', $employee->id) }}" enctype="multipart/form-data" class="space-y-5">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input id="name" name="name" type="text" placeholder="أدخل اسم الموظف"
                                   class="form-input" value="{{ old('name', $employee->name) }}" required />
                        </div>
                        ...
                        <div>
                            ...
                            <input id="phone" name="phone" type="text" placeholder="أدخل رقم الهاتف"
                                   class="form-input" value="{{ old('phone', $employee->phone) }}" required />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        @if($employee->photo)
                            <div class="mt-3">
                                ...
                                <img src="{{ Storage::url($employee->photo) }}" alt="صورة الموظف"
                    ...
                    <div class="flex items-center justify-end gap-4">
                        <a href="{{ route('admin.employees.index') }}" class="btn btn-outline-danger">
                            إلغاء
                        </a>
