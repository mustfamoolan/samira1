<x-layout.default>
    <div>
        ...
        <div class="pt-5">
            <div class="panel">
                <div class="mb-5">
                    <h5 class="font-semibold text-lg dark:text-white-light">إضافة طبيب جديد</h5>
                </div>
                ...
                <form method="POST" action="{{ route('admin.doctors.store') }}" enctype="multipart/form-data" class="space-y-5">
                    @csrf
