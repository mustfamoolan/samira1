    ...
    <div>
        <ul class="flex space-x-2 rtl:space-x-reverse">
            ...
            <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
                <a href="{{ route('admin.doctors.index') }}" class="text-primary hover:underline">الأطباء</a>
            </li>
            <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
        ...
        <div class="pt-5">
            <div class="panel">
                <div class="mb-5">
                    <h5 class="font-semibold text-lg dark:text-white-light">تعديل الطبيب: {{ $doctor->name }}</h5>
                </div>
                ...
                <form method="POST" action="{{ route('admin.doctors.update', $doctor->id) }}" enctype="multipart/form-data" class="space-y-5">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input id="name" name="name" type="text" placeholder="أدخل اسم الطبيب"
                                   class="form-input" value="{{ old('name', $doctor->name) }}" required />
                        </div>
                        ...
                        <div>
                            ...
                            <input id="phone" name="phone" type="text" placeholder="أدخل رقم الهاتف"
                                   class="form-input" value="{{ old('phone', $doctor->phone) }}" required />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        @if($doctor->photo)
                            <div class="mt-3">
                                ...
                                <img src="{{ Storage::url($doctor->photo) }}" alt="صورة الطبيب"
                    ...
                    <div class="flex items-center justify-end gap-4">
                        <a href="{{ route('admin.doctors.index') }}" class="btn btn-outline-danger">
                            إلغاء
                        </a>
