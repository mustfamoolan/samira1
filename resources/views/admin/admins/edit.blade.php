<x-layout.default>
    <div>
        ...
        <div class="pt-5">
            <div class="panel">
                <div class="mb-5">
                    <h5 class="font-semibold text-lg dark:text-white-light">تعديل المدير العام: {{ $admin->name }}</h5>
                </div>
                ...
                <form method="POST" action="{{ route('admin.admins.update', $admin->id) }}" enctype="multipart/form-data" class="space-y-5">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input id="name" name="name" type="text" placeholder="أدخل اسم المدير العام"
                                   class="form-input" value="{{ old('name', $admin->name) }}" required />
                        </div>
                        ...
                        <div>
                            ...
                            <input id="phone" name="phone" type="text" placeholder="أدخل رقم الهاتف"
                                   class="form-input" value="{{ old('phone', $admin->phone) }}" required />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        @if($admin->photo)
                            <div class="mt-3">
                                ...
                                <img src="{{ Storage::url($admin->photo) }}" alt="صورة المدير"
