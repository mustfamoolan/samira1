<x-layout.admin>
    <div class="panel">
        <div class="mb-5">
            <h5 class="font-semibold text-lg dark:text-white-light">إدارة المرضى</h5>
        </div>
        <div class="mb-5">
        ...
        <div class="table-responsive">
            <table id="patientsTable" class="table-hover">
                <thead>
                    <tr>
                        <th>الاسم الرباعي</th>
                        <th>الرقم الوطني</th>
            ...
            patientsData.forEach((patient, index) => {
                const actionsHtml = `
                    <div class="flex items-center space-x-2 rtl:space-x-reverse">
                        <a href="/admin/patients/${patient.id}/edit" class="btn btn-sm btn-outline-primary">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                            </svg>
                            تعديل
                        </a>
                        <button onclick="deletePatient(${patient.id})" class="btn btn-sm btn-outline-danger">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                `;
                patientsData[index][9] = actionsHtml;
            });
