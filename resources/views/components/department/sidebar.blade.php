            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="nav-item">
                    @php
                        ...
                        $dashboardRoute = auth('employee')->check() ? 'employee.dashboard' : 'department-manager.dashboard';
                    @endphp
                    <a href="{{ route($dashboardRoute) }}" class="nav-link group">
                ...
                <!-- إدارة الأقسام - للمدير العام فقط -->
                @if(auth('admin')->check())
                <li class="nav-item">
