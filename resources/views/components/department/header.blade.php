                    ...
                    <a href="javascript:;" class="relative group" @click="toggle()">
                        <span>
                            @php
                                ...
                                $userType = auth('employee')->check() ? 'موظف' : 'مسؤول قسم';
                            @endphp
                            @if($user && $user->photo)
                        ...
                        <li>
                            <div class="flex items-center px-4 py-4">
                                ...
                                <div class="ltr:pl-4 rtl:pr-4 truncate">
                                    <h4 class="text-base">{{ $user ? $user->name : 'مستخدم' }}<span
                                            class="text-xs bg-success-light rounded text-success px-1 ltr:ml-2 rtl:ml-2">{{ $userType }}</span>
                                    </h4>
                                    <a class="text-black/60 hover:text-primary dark:text-dark-light/60 dark:hover:text-white"
                                        href="javascript:;">{{ $user ? $user->phone : 'غير محدد' }}</a>
                                </div>
                            </div>
                        </li>
                        <li>
