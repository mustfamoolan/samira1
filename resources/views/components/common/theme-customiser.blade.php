    ...
    <nav class="bg-white fixed ltr:-right-[400px] rtl:-left-[400px] top-0 bottom-0 w-full max-w-[400px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-[right] duration-300 z-[51] dark:bg-[#0e1726] p-4"
        ...
        <div class="overflow-y-auto overflow-x-hidden perfect-scrollbar h-full">
            <div class="text-center relative pb-5">
                ...
                <p class="text-white-dark">حدد التفضيلات التي ستكون محفوظة لمعاينة العرض المباشر.</p>
            </div>
            <div class="border border-dashed border-[#e0e6ed] dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                ...
                <p class="text-white-dark text-xs">عرض عام فاتح أو داكن.</p>
            ...
            <div class="border border-dashed border-[#e0e6ed] dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                <h5 class="mb-1 text-base dark:text-white leading-none">موضع التنقل</h5>
                <p class="text-white-dark text-xs">اختر نموذج التنقل الأساسي لتطبيقك.</p>
                <div class="grid grid-cols-3 gap-2 mt-3">
                    <button type="button" class="btn"
            ...
            <div class="border border-dashed border-[#e0e6ed] dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                ...
                <p class="text-white-dark text-xs">اختر نمط التخطيط الأساسي لتطبيقك.</p>
            ...
            <div class="border border-dashed border-[#e0e6ed] dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                ...
                <p class="text-white-dark text-xs">اختر الاتجاه لتطبيقك.</p>
                <div class="flex gap-2 mt-3">
                    <button type="button" class="btn flex-auto"
            ...
            <div class="border border-dashed border-[#e0e6ed] dark:border-[#1b2e4b] rounded-md mb-3 p-3">
                <h5 class="mb-1 text-base dark:text-white leading-none">انتقال الموجه</h5>
                <p class="text-white-dark text-xs">حركة المحتوى الرئيسي.</p>
                <div class="mt-3">
