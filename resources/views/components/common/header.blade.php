<header class="z-40" :class="{ 'dark': $store.app.semidark && $store.app.menu === 'horizontal' }">
    <div class="shadow-sm">
        <div class="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-[#0e1726]">
            <div class="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                <a href="/" class="main-logo flex items-center shrink-0">
                    <img class="w-8 ltr:-ml-1 rtl:-mr-1 inline" src="{{ $siteLogo }}"
                        alt="image" />
                    <span
                        class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline dark:text-white-light transition-all duration-300">{{ $siteName }}</span>
                </a>
            ...
            <div x-data="header"
                ...
                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                    ...
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                        class="ltr:right-0 rtl:left-0 text-dark dark:text-white-dark top-11 !py-0 w-[250px] font-semibold dark:text-white-light/90">
                        <li>
                            <div class="flex items-center px-4 py-4">
                                ...
                                <div class="ltr:pl-4 rtl:pr-4 truncate">
                                    <h4 class="text-base">{{ auth('admin')->user()->name }}<span
                                            class="text-xs bg-success-light rounded text-success px-1 ltr:ml-2 rtl:ml-2">مدير عام</span>
                                    </h4>
                                    <a class="text-black/60 hover:text-primary dark:text-dark-light/60 dark:hover:text-white"
                                        href="javascript:;">{{ auth('admin')->user()->phone }}</a>
                                </div>
                            </div>
                        </li>
                        <li>
                            <a href="{{ route('admin.dashboard') }}" class="dark:hover:text-white" @click="toggle">
                        ...
                        <li>
                            <a href="{{ route('admin.admins.edit', auth('admin')->user()->id) }}" class="dark:hover:text-white" @click="toggle">
                                <svg class="w-4.5 h-4.5 ltr:mr-2 rtl:ml-2 shrink-0" width="18" height="18"
                                    viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="border-t border-white-light dark:border-white-light/10">
                            <form method="POST" action="{{ route('admin.logout') }}">
                                @csrf
                                <button type="submit" class="w-full text-left text-danger !py-3 hover:bg-danger-light hover:text-danger" @click="toggle">
                    ...
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                        ...
                        <li>
                            <div class="flex items-center px-4 py-4">
                                ...
                                <div class="ltr:pl-4 rtl:pr-4 truncate">
                                    <h4 class="text-base">زائر<span
                                            class="text-xs bg-warning-light rounded text-warning px-1 ltr:ml-2 rtl:ml-2">Guest</span>
                                    </h4>
                                    <a class="text-black/60 hover:text-primary dark:text-dark-light/60 dark:hover:text-white"
                        ...
                        <li>
                            <a href="{{ route('login') }}" class="dark:hover:text-white" @click="toggle">
                                <svg class="w-4.5 h-4.5 ltr:mr-2 rtl:ml-2 shrink-0" width="18" height="18"
                                    viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.5"
                                        d="M2 12C2 8.22876 2 6.34315 3.17157 5.17157C4.34315 4 6.22876 4 10 4H14C17.7712 4 19.6569 4 20.8284 5.17157C22 6.34315 22 8.22876 22 12V14C22 17.7712 22 19.6569 20.8284 20.8284C19.6569 22 17.7712 22 14 22H10C6.22876 22 4.34315 22 3.17157 20.8284C2 17.6569 2 15.7712 2 14V12Z"
                                        stroke="currentColor" stroke-width="1.5" />
                                    <path opacity="0.5" d="M10 16H6" stroke="currentColor" stroke-width="1.5"
                                        stroke-linecap="round" />
                                    <path opacity="0.5" d="M14 16H12.5" stroke="currentColor" stroke-width="1.5"
        ...
        <ul
            ...
            <li class="menu nav-item relative">
                <a href="javascript:;" class="nav-link">
                    <div class="flex items-center">
                        ...
                        <span class="px-1">إدارة المستخدمين</span>
                    </div>
            ...
            <li class="nav-item">
                <a href="{{ route('admin.departments.index') }}" class="nav-link">
                    <div class="flex items-center">
                        ...
                        <span class="px-1">إدارة الأقسام</span>
                    </div>
                </a>
            </li>
            ...
            <!-- إدارة الحقن -->
            <li class="nav-item">
                <a href="{{ route('admin.injections.index') }}" class="nav-link">
                    <div class="flex items-center">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg" class="shrink-0">
                            <path opacity="0.5"
                                d="M3 13.1928C3 9.2449 3 7.27095 4.17157 6.09937C5.34315 4.92779 7.3171 4.92779 11.265 4.92779H12.735C16.6829 4.92779 18.6569 4.92779 19.8284 6.09937C21 7.27095 21 9.2449 21 13.1928V14.8072C21 18.7551 21 20.7291 19.8284 21.9006C18.6569 23.0722 16.6829 23.0722 12.735 23.0722H11.265C7.3171 23.0722 5.34315 23.0722 4.17157 21.9006C3 20.7291 3 18.7551 3 14.8072V13.1928Z"
                                fill="currentColor" />
                            <path
                                d="M12 8.5C12.4142 8.5 12.75 8.83579 12.75 9.25V10.25H13.75C14.1642 10.25 14.5 10.5858 14.5 11C14.5 11.4142 14.1642 11.75 13.75 11.75H12.75V12.75C12.75 13.1642 12.4142 13.5 12 13.5C11.5858 13.5 11.25 13.1642 11.25 12.75V11.75H10.25C9.83579 11.75 9.5 11.4142 9.5 11C9.5 10.5858 9.83579 10.25 10.25 10.25H11.25V9.25C11.25 8.83579 11.5858 8.5 12 8.5Z"
                                fill="currentColor" />
                        </svg>
                        <span class="px-1">إدارة الحقن</span>
                    </div>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="{{ route('admin.settings.edit') }}" class="nav-link">
                    <div class="flex items-center">
                        ...
                        <span class="px-1">إعدادات الموقع</span>
                    </div>
                </a>
            </li>
        </ul>
